...
void PollingFunction(I2C_Handle *I2CHandle, I2C_Transaction *I2CTransaction, float *temperature)
{
...
void PollingFxn(UArg arg0, UArg arg1)
{
    ...
    HTU21DSoftreset(&I2CHandle, &I2CTransaction);
        /* ...
         * default werte lesen implementieren?
         * ...*/


    while(1) {

        PollingFunction(&I2CHandle, &I2CTransaction, &temp);
        /*TODO: Mailbox_send*/
        Task_sleep(1000);
