...
linker.cmd: package/cfg/httpget_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/httpget_pem4fcfg.cmd\)\"$""\"C:/Users/Hannes/git/Wetterstation/tivia-c/ESE_Wetterstation/.config/xconfig_httpget/\1\""' package/cfg/httpget_pem4f.xdl > $@
